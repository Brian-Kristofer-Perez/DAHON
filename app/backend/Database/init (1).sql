...
INSERT INTO `plant` VALUES (2,'Tomato','Solanum lycopersicum','Solanaceae','Fruit'),(3,'Grape','Vitis vinifera (European grape), Vitis labrusca (American grape), etc.','Vitaceae','Fruit'),(4,'Blueberry','Vaccinium corymbosum (Highbush), Vaccinium angustifolium (Lowbush)','Ericaceae','Fruit'),(6,'Cherry','Prunus avium (Sweet cherry), Prunus cerasus (Sour cherry)','Rosaceae','Fruit'),(7,'Strawberry','Fragaria × ananassa','Rosaceae','Fruit'),(8,'Pepper Bell','Capsicum annuum','Solanaceae','Fruit'),(11,'Orange','Citrus × sinensis','Rutaceae','Fruit'),(12,'Soybean','Glycine max','Fabaceae','Legume'),(29,'Squash','Cucurbita pepo','Cucurbitaceae','Fruit'),(30,'Potato','Solanum tuberosum','Solanaceae','Tuberous root vegetable'),(31,'Corn','Zea mays','Poaceae','Annual cereal grain'),(32,'Peach','Prunus persica','Rosaceae','Deciduous fruit tree'),(33,'Apple','Malus domestica','Rosaceae','Deciduous fruit tree');
